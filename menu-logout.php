...
$obj = new ForEx();
$arrayInput = $obj->readSiteConf("confLogin", "confType", "logout");
...
<head>
    ...
    <link href="http://cdn-na.infragistics.com/igniteui/latest/css/themes/infragistics/infragistics.theme.css"
        rel="stylesheet">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6" style="margin-top:50px">
                <select name="sites" class="mdb-select md-form form-control" id="sitesList"
                    style="outline:none !important">
                    <?php
                    $obj->readPagePropertiesInOption("siteName,siteLink", "logout", "", "", "siteType")
                    ?>
                </select>
